        ...
        <div className="relative w-full overflow-hidden">
          ...
          >
            ...
            >
              ...
              <div className="absolute bottom-0 right-0 w-8 h-8 rounded-full bg-white/70 dark:bg-[#212121]/80 backdrop-blur-sm border border-border/80 dark:border-neutral-700 flex items-center justify-center transition-transform">
                {loading ? (
